        ...
        <div className="w-full max-w-md p-10 bg-mischka-100 rounded-[40px] shadow-2xl shadow-mischka-200 border border-mischka-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                    <label className="text-[13px] font-bold text-mischka-500 uppercase tracking-widest ml-1">Full Name</label>
                    <div className="relative group">
                        <UserIcon className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-mischka-400 group-focus-within:text-mischka-900 transition-colors" />
                        <input
                            type="text"
                            required
                ...
                <div className="space-y-2">
                    <label className="text-[13px] font-bold text-mischka-500 uppercase tracking-widest ml-1">Password</label>
                    <div className="relative group">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-mischka-600 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-mischka-700 transition-all shadow-xl shadow-mischka-200 group active:scale-95 mt-4 disabled:opacity-50"
                >
